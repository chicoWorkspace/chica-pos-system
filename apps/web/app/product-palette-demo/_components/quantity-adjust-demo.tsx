    ...
    <div className="space-y-3">
      ...
      {quantityItems.map((item) => {
        ...
        return (
          <div
            key={item.key}
            className="flex items-center justify-between rounded-2xl border border-white/15 bg-white/5 px-3 py-2"
          >
            <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="min-w-[56px] rounded-xl border border-white/15 bg-[#1A2231] px-3 py-2 text-center text-sm font-semibold text-white">
                {value}
              </div>
