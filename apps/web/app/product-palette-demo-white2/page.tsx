              ...
              <div className={cls.dialog.section}>
                ...
                <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                  <div>
                    ...
                    <div className={`mt-2 rounded-2xl ${cls.section.card} p-2`}>
              ...
              <div className={`${cls.section.innerCard} p-4`}>
                ...
                >
                  <div className="grid w-full grid-cols-3 gap-1">
                    <button
                      className={`flex items-center justify-center gap-1.5 rounded-xl border bg-transparent px-3 py-2 text-sm transition-colors border-[#0b0b0b] ${cls.text.strong}`}
                    >
                      <ReceiptText className="h-4 w-4" />
                      橫向卡片
                    </button>
                    <button
                      className={`flex items-center justify-center gap-1.5 rounded-xl border  bg-[#0b0b0b]/20 px-3 py-2 text-sm  shadow-[0_6px_14px_rgba(111,123,247,0.22)] transition-colors hover:bg-[#0b0b0b]/24 ${cls.text.strong}`}
                    >
                      <Layers3 className="h-4 w-4" />
                      直式卡片
                    </button>
                    <button
                      className={`flex items-center justify-center gap-1.5 rounded-xl border border-transparent bg-transparent px-3 py-2 text-sm transition-colors border-[#0b0b0b]  ${cls.text.strong}`}
                    >
        ...
        <section className={`${cls.section.shell} mt-6`}>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className={cls.section.innerCard + " p-4"}>
              ...
              <div>
                <div className="text-sm font-semibold">橫向-白</div>
                <div className={horizontalProductCardCls.shell}>
                  <div className={horizontalProductCardCls.rowWrap}>
                    ...
                    <div className={horizontalProductCardCls.contentArea}>
                      ...
                      <div
                        className={`${horizontalProductCardCls.middleSection} flex items-center gap-3 px-4 py-3 `}
                      >
                        {/* Spec select */}
